    ...
    extends Omeka_Controller_AbstractActionController
{
    ...
    public function serverAction()
    {
        ...
        if (ESearch_Helpers_Index::pingEServer()) {

            // Notify valid connection.
            $this->_helper->flashMessenger(
                __('E connection is valid.'), 'success'
            );
        ...
        // Notify invalid connection.
            ...
            __('E connection is invalid.'), 'error'
        );
    ...
    protected function _collectionsForm()
    {
        ...
        $form = new Zend_Form();
        $form->setAction(url('esearch/collections'))->setMethod('post');
    ...
    {
        $fieldTable = $this->_helper->db->getTable('ESearchField');
        $fieldTable->updateFacetMappings();
        $this->redirect('esearch/fields');
    }
