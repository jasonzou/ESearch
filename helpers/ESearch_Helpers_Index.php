...
class ESearch_Helpers_Index
{
     ...
     * @author Eric Rochester <erochest@virginia.edu>
     */
    public static function pingEServer($options=array())
    {
        try {
    ...
    public static function indexAll($options=array())
    {
        ...
        $excTable = $db->getTable('ESearchExclude');
        $excludes = array();
        ...
        // First get the items.
        $pager = new ESearch_DbPager($db, $table, $select);
        ...
        $mgr  = new ESearch_Addon_Manager($db);
